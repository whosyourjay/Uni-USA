...
| `sat-percentile-1600.csv`, `sat-percentile-math.csv`, `sat-percentile-rw.csv` | Historical SAT table compilation | Annual College Board SAT-user percentile tables; used to recover same-cohort 2019 total and section distributions and spread each rounded percentile interval across its score buckets | <https://docs.google.com/spreadsheets/d/e/2PACX-1vRVCIukssgc3z5-8GpH3achzkJhbxD0TID_q8Xa-1oZIsF_NMy-U5exxEUr8EZi2Q/pubhtml#gid=273576492> |
...
| `2018-act-national-profile.pdf`, `2020-act-national-profile.pdf`–`2025-act-national-profile.pdf` | ACT | Exact same-cohort English, Math, Reading, Science, and Composite frequencies, Table 2.1 | <https://www.act.org/content/dam/act/unsecured/documents/cccr2018/P_99_999999_N_S_N00_ACT-GCPR_National.pdf> |
